//The class header here declares the functions from the implementation. They are declared 
//extern which tells the compiler that they are defined elsewhere and will be available
//when all the files are linked together. 
